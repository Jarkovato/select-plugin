...
var getTemplate = function getTemplate() {
  ...
  var text = placeholder !== null && placeholder !== void 0 ? placeholder : 'Текст';
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function clickHandler(event) {
      var type = event.target.dataset.type; //клик на инпут

      if (type === 'input') {
        this.toggle(); //клик на список
      } else if (type === 'item') {
...
},{"./bundle-url":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/style.sass":[function(require,module,exports) {
...
window.s = select;
},{"./select/select":"select/select.js","./select/style.sass":"select/style.sass"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
